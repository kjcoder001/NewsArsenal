...
public class HeadlinesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.headline_fragment,container,false);
        service = ApiUtils.getService();
        recyclerView = (RecyclerView)rootView.findViewById(R.id.headlineRecyclerView);
    ...
    {
        service.getWorldNews().enqueue(new Callback<Root>() {
            @Override
